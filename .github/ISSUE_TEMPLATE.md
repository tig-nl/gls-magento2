...
### Make sure you are using the *latest* version: https://github.com/tig-nl/gls-magento2/releases
Issues with outdated version will be rejected.
- [ ] I've **verified** and **I assure** that I'm running the latest version of the TIG GLS Magento 2 extension.
...
- [ ] Bug report (encountered problems with the TIG GLS Magento 2 extension)
