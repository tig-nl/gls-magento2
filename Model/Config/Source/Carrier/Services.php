...
class Services implements ArrayInterface
{
    ...
    const GLS_CARRIER_SERVICE_EXPRESS_TIME_DEFINITE_T12_LABEL = 'TimeDefiniteService (Before 12.00 PM)';
    const GLS_CARRIER_SERVICE_EXPRESS_TIME_DEFINITE_T17       = 'T17';
    const GLS_CARRIER_SERVICE_EXPRESS_TIME_DEFINITE_T17_LABEL = 'TimeDefiniteService (Before 5.00 PM)';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T9             = 'S9';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T9_LABEL       = 'TimeDefiniteService (Saturday before 9.00 AM)';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T12            = 'S12';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T12_LABEL      = 'TimeDefiniteService (Saturday before 12.00 PM)';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T17            = 'S17';
    const GLS_CARRIER_SERVICE_EXPRESS_SATURDAY_T17_LABEL      = 'TimeDefiniteService (Saturday before 5.00 PM)';
