...
namespace TIG\GLS\Model\Config\Backend;
...
class Tablerate extends \Magento\Framework\App\Config\Value
{
    ...
    {
        /** @var \TIG\GLS\Model\ResourceModel\Carrier\GLS $tableRate */
        $tableRate = $this->glsFactory->create();
