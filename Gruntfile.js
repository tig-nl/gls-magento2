...
module.exports = function (grunt) {
    ...
    if (grunt.file.isDir('/tmp/magento2/')) {
        ...
        phpunitXmlPath = '/tmp/magento2/vendor/tig/gls/phpunit.xml.dist';
    }
    ...
    grunt.initConfig({
        ...
        exec: {
            ...
            integrationTests:
                ...
                'php -ddisplay_errors=1 ../../../vendor/phpunit/phpunit/phpunit --testsuite "TIG GLS Tests"',
            ...
            phraseTest:
                'cd ' + magento2path + ' && php bin/magento i18n:collect-phrases vendor/tig/gls',
